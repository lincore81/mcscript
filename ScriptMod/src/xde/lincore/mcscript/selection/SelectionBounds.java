...
public final class SelectionBounds {
	...
	public SelectionBounds(int x1, int x2, int y1, int y2, int z1, int z2) {
	...
	public SelectionBounds add(SelectionBounds other) {
		SelectionBounds result = new SelectionBounds();
