...
public class VectorTurtleDialect extends CommonTurtleSpeak {
		private final VectorTurtle turtle;
		...
		private static final int SNAP	= 0xf3;
		...
		public void registerKeywords(final Set<TsKeyword> keywords) {
			...
			keywords.add(new TsKeyword(SNAP,	"snap", 	"sn(ap)?", 		false));
		}


		@Override
		public TsBlock onStatement(final TsStatement command) {
		...
		public VectorTurtleDialect(final VectorTurtle turtle) {
			this.turtle = turtle;
		}
	}
